...
RCD         = {   
                  'Config'		               : 1,                                                                    #? [/]      - Configuration of the RCD
                  'R'                        : 1e5,                                                                  #? [Ohm]    - Resistor value in the RCD snubber 
                  'C'                        :  {                                                                                           
                        'Config'		         : 1,                                                                    #? [/]      - Configuration of the RCD capacitor
                        'Cap_s'              : 10e-6,                                                                #? [F]      - RCD capacitance value 
                  ...
                  'diode'                    : {
                        'Config'		         : 1,                                                                    #? [/]      - Configuration of the snubber capacitor
                        'therm_diode'		   : 'file:C4D40120D',                                                     #? [/]      - Diode model file path       
